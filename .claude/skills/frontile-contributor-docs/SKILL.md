...
```bash
node .claude/skills/frontile-contributor-docs/scripts/lint-docs.mjs                    # everything
node .claude/skills/frontile-contributor-docs/scripts/lint-docs.mjs --since HEAD FILE   # + demo loss
```
