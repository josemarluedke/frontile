...
<template>
  <div class='space-y-4'>
    ...
    <a
      class='inline-block px-4 py-2 bg-primary-soft text-white rounded hover:bg-primary-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-soft focus-visible:ring-offset-2'
