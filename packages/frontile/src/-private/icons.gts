/**
 * Icon components shared across Frontile components (buttons, forms,
 * disclosure, navigation, collections, status/notifications). Kept in one
 * place to avoid duplicating the same SVG in multiple component folders.
 */
...
export const ChevronDoubleLeftIcon: TOC<IconSignature> = <template>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const ChevronDoubleRightIcon: TOC<IconSignature> = <template>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const IconChevronUpDown: TOC<IconSignature> = <template>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const IconCalendar: TOC<IconSignature> = <template>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const IconInfo: TOC<IconSignature> = <template>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const IconSuccess: TOC<IconSignature> = <template>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const IconWarning: TOC<IconSignature> = <template>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const IconDanger: TOC<IconSignature> = <template>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
