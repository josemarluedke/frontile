export const safelist = [
  ...
  'overlay-transition--tooltip-enter',
  'overlay-transition--tooltip-enter-to',
  'overlay-transition--tooltip-leave',
  'overlay-transition--tooltip-leave-to',
  'overlay-transition--tooltip-enter-active',
  'overlay-transition--tooltip-leave-active',
  'overlay-transition--command-enter',
  'overlay-transition--command-enter-to',
  'overlay-transition--command-leave',
  'overlay-transition--command-leave-to',
  'overlay-transition--command-enter-active',
  'overlay-transition--command-leave-active',
  'drawer--vertical-xs',
