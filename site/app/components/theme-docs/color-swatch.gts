...
export default class ColorSwatch extends Component<ColorSwatchSignature> {
  ...
  private bgClassMap: Record<string, string> = {
    ...
    'tertiary-subtle': 'bg-tertiary-subtle',
    'secondary-muted': 'bg-secondary-muted',
    'tertiary-muted': 'bg-tertiary-muted',
    'secondary-soft': 'bg-secondary-soft',
    'tertiary-soft': 'bg-tertiary-soft',
    'secondary-mild': 'bg-secondary-mild',
    'tertiary-mild': 'bg-tertiary-mild',
    'secondary-DEFAULT': 'bg-secondary',
    'tertiary-DEFAULT': 'bg-tertiary',
    'secondary-firm': 'bg-secondary-firm',
    'tertiary-firm': 'bg-tertiary-firm',
    'secondary-strong': 'bg-secondary-strong',
    'tertiary-strong': 'bg-tertiary-strong',
    'secondary-bolder': 'bg-secondary-bolder',
    'tertiary-bolder': 'bg-tertiary-bolder',
    'success-subtle': 'bg-success-subtle',
    'success-muted': 'bg-success-muted',
    'success-soft': 'bg-success-soft',
    'success-mild': 'bg-success-mild',
  ...
  private onColorClassMap: Record<string, string> = {
    ...
    'neutral-mild': 'text-on-neutral-mild',
    ...
    'primary-mild': 'text-on-primary-mild',
    ...
    'secondary-subtle': 'text-on-secondary-subtle',
    'tertiary-subtle': 'text-on-tertiary-subtle',
    'secondary-muted': 'text-on-secondary-muted',
    'tertiary-muted': 'text-on-tertiary-muted',
    'secondary-soft': 'text-on-secondary-soft',
    'tertiary-soft': 'text-on-tertiary-soft',
    'secondary-mild': 'text-on-secondary-mild',
    'tertiary-mild': 'text-on-tertiary-mild',
    'secondary-DEFAULT': 'text-on-secondary',
    'tertiary-DEFAULT': 'text-on-tertiary',
    'secondary-firm': 'text-on-secondary-firm',
    'tertiary-firm': 'text-on-tertiary-firm',
    'secondary-strong': 'text-on-secondary-strong',
    'tertiary-strong': 'text-on-tertiary-strong',
    'secondary-bolder': 'text-on-secondary-bolder',
    'tertiary-bolder': 'text-on-tertiary-bolder',
    'success-subtle': 'text-on-success-subtle',
    'success-muted': 'text-on-success-muted',
    'success-soft': 'text-on-success-soft',
    'success-mild': 'text-on-success-mild',
    ...
    'danger-mild': 'text-on-danger-mild',
    ...
    'warning-mild': 'text-on-warning-mild',
