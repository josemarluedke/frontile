            ...
            <ul class="space-y-0">
              ...
              {{#each child.children as |subChild|}}
                <li>
                  <button
                    type="button"
                    class="flex w-full items-center justify-between px-6 py-1.5 text-left text-sm text-neutral-strong hover:text-neutral-firm hover:bg-neutral-muted/50 outline-none focus-visible:ring-2 focus-visible:ring-primary-soft rounded"
                    {{on
                      "click"
                      (fn
                        this.toggleSection
