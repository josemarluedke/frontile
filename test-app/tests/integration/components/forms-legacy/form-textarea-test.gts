...
module(
  ...
  function (hooks) {
    ...
    test('it renders html attributes', async function (assert) {
      await render(
        <template>
          <FormTextarea @label="Name" name="some-name" data-test-input />
        </template>
      );
    ...
    test('it should have id attr with matching label attr `for`', async function (assert) {
      await render(
        <template><FormTextarea @label="Comment" data-test-input /></template>
      );
    ...
    test('it adds container class from @containerClass arg', async function (assert) {
      await render(
        <template>
          <FormTextarea @containerClass="my-container-class" />
        </template>
      );
