...
module(
  'Integration | Component | @frontile/forms-legacy/FormRadio',
  function (hooks) {
    ...
    test('it renders the label from argument', async function (assert) {
      await render(
        <template>
          <FormRadio data-test-input @label="My Radio Input" />
        </template>
      );
    ...
    test('it should have id attr with matching label attr `for`', async function (assert) {
      await render(
        <template><FormRadio @label="Something" data-test-input /></template>
      );
    ...
    test('it renders the `name` HTML attribute', async function (assert) {
      await render(
        <template><FormRadio data-test-input name="my-input" /></template>
      );
    ...
    test('it adds container class from @containerClass arg', async function (assert) {
      await render(
        <template><FormRadio @containerClass="my-container-class" /></template>
      );
